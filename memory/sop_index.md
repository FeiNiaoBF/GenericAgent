...
| SOP | 用途 | 触发词 |
|-----|------|--------|
| `daily_task_plan_sop.md` | 每日开场/清点/收尾 | 早晨 |
| `daily_news_fetch_sop.md` | 新闻简报 | 新闻 |
| `task_backend_manage_sop.md` | 后台任务/定时调度/自主执行/Goal Mode | task_backend、后台、goal |
| `gongji_exam_review_sop.md` | 公基备考(4Phase) | 公基、刷题 |

## TOOLS · 工具
| SOP | 用途 | 触发词 |
|-----|------|--------|
| `tmwebdriver_sop.md` | 浏览器自动化(TW) | 网页、cookie |
| `tg_unified_send_sop.md` | TG统一(通知+渲染+贴纸) | Telegram |
| `ljqCtrl_sop.md` | 键鼠模拟 | 点击、快捷键 |
| `web_search_sop.md` | Google搜索 | 搜索 |
| `skill_discovery_sop.md` | 技能发现-评估-集成 | 找工具、找库 |
| `git_operate_sop.md` | 分支模型+提交规范+故障恢复 | commit、push、merge、cherry-pick、分支、PR |
...
| SOP | 用途 | 触发词 |
|-----|------|--------|
| `guizang_ppt_build_sop.md` | PPT生成(归藏风格) | PPT |
